 ...
 */
//void vad_dct_forward48(int32_t output[48], int32_t input[48]);
 ...
 *  \param  output          DCT values.
 */
//void vad_dct_forward32(int32_t output[32], int32_t input[32]);
 ...
 *  \param  output          DCT values.
 */
//void vad_dct_forward16(int32_t output[16], int32_t input[16]);
 ...
 *  \param  output          DCT values.
 */
//void vad_dct_forward12(int32_t output[12], int32_t input[12]);
 ...
 *  \param  output          DCT values.
 */
//void vad_dct_forward8(int32_t output[8], int32_t input[8]);
 ...
 *  \param  output          DCT values.
 */
//void vad_dct_forward6(int32_t output[6], int32_t input[6]);
 ...
 *  \param  output          DCT values.
 */
//void vad_dct_forward4(int32_t output[4], int32_t input[4]);
 ...
 *  \param  output          DCT values.
 */
//void vad_dct_forward2(int32_t output[2], int32_t input[2]);
 ...
 *  \param  output          DCT values.
 */
//void vad_dct_forward1(int32_t output[1], int32_t input[1]);
 ...
 */
//void vad_dct_inverse4(int32_t output[4], int32_t input[4]);
 ...
 *  \param  output          output signal
 */
//void vad_dct_inverse3(int32_t output[3], int32_t input[3]);
 ...
 *  \param  output          output signal
 */
//void vad_dct_inverse2(int32_t output[2], int32_t input[2]);
 ...
 *  \param  output          output signal
 */
//void vad_dct_inverse1(int32_t output[1], int32_t input[1]);
