 ...
 *
 * This structure contains necessary state for the VAD to look back 
 * over previous samples from a new frame and previous sets of features
 * generated by previous frames.
 *
 * @ingroup vad_state
 */
typedef struct {
