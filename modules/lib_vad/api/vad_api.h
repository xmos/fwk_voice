...
/**
 * @brief VAD state structure definition
 *
 * This structure contains state for the VAD to build an input frame
 * which includes samples from the previous frame as well as a 
 * history of features generated by previous frames to feed into the
