...
vad_profile_xe = os.path.abspath("../../../build/test/lib_vad/test_vad_profile/bin/fwk_voice_test_vad_profile_VAD_ENABLED.xe")
vad_profile_xe_empty = os.path.abspath("../../../build/test/lib_vad/test_vad_profile/bin/fwk_voice_test_vad_profile_VAD_DISABLED.xe")
