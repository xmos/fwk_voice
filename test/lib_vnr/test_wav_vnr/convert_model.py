...
if __name__ == "__main__":
    ...
    if args.copy_files:
        ...
        print(f"WARNING: Copying files to {vnr_module_path}. Verify before committing!")
        ...
        shutil.copy2(os.path.join(test_dir, "vnr_quant_spec_defines.h"), os.path.join(vnr_module_path, "api/features/"))
