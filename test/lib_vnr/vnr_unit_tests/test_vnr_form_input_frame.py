...
def test_vnr_form_input_frame():
    ...
    op = test_utils.run_dut(input_data, "test_vnr_form_input_frame", os.path.abspath('../../../build/test/lib_vnr/vnr_unit_tests/bin/avona_test_vnr_form_input_frame.xe')) # dut data has exponent followed by 257*2 data values
