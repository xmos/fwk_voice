...
def test_vnr_full(target, tflite_model):
    ...
    assert(geo_closeness > 0.9997), "inference output geo_closeness below pass threshold"
    assert(arith_closeness > 0.9993), "inference output arith_closeness below pass threshold"
