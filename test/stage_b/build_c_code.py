...
""",
    ...
    libraries=['avona_module_lib_ic', 'avona_module_lib_aec', 'avona_module_lib_vad', 'avona_module_lib_vnr_inference', 'avona_module_lib_vnr_features', 'avona_deps_lib_xs3_math', 'm', 'stdc++'],    # on Unix, link with the math library. Linking order is important here for gcc compile on Linux
