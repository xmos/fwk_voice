...
""",
    ...
    libraries=['fwk_voice_module_lib_ic', 'fwk_voice_module_lib_aec', 'fwk_voice_module_lib_vnr_inference', 'fwk_voice_module_lib_vnr_features', 'lib_xcore_math', 'lib_tflite_micro', 'm', 'stdc++'],    # on Unix, link with the math library. Linking order is important here for gcc compile on Linux
