...
def pytest_sessionstart(session):
    ...
    #input_wav_files = [os.path.join(hydra_audio_base_dir, "xvf3510_3610_ffrs_test/recordings/xvf3610_v5_0_0_packed_recordings/20210902_xvf3610_v5_0_0_rerun_packed_1/unpacked/Barge_69dBA_BargeIn_39dB_unpacked_SC50.wav")]
