...
pipeline_bins = {
                ...
                "alt_arch"  :    {"x86" : os.path.abspath("../../build/examples/bare-metal/pipeline_alt_arch/bin/avona_example_bare_metal_pipeline_alt_arch_st"),
                                "xcore" : os.path.abspath("../../build/examples/bare-metal/pipeline_alt_arch/bin/avona_example_bare_metal_pipeline_alt_arch_mt.xe")}
                }
...
def pytest_sessionstart(session):
    ...
    try:
        full_pipeline_run = 1 #int(os.environ['PIPELINE_FULL_RUN'])
    except:
    ...
    #input_wav_files = [os.path.join(hydra_audio_path, "InHouse_XVF3510v080_v1.2_20190423_Loc1_Noise2_70dB__Take1.wav"), os.path.join(hydra_audio_path, "InHouse_XVF3510v080_v1.2_20190423_Loc2_Noise2_70dB__Take1.wav"), os.path.join(hydra_audio_path, "InHouse_XVF3510v080_v1.2_20190423_Loc3_Noise2_70dB__Take1.wav")]
