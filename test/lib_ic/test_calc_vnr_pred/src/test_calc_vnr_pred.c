...
void test(int32_t *output, int32_t *input)
{
    ...
    //printf("input_pred = %f, output_pred = %f\n",float_s32_to_double(ic_state.ic_vnr_pred_state.input_vnr_pred), float_s32_to_double(ic_state.ic_vnr_pred_state.output_vnr_pred));
    // Write to output buffer
    memcpy(&output[0], &ic_state.ic_vnr_pred_state.input_vnr_pred, sizeof(float_s32_t));
    memcpy(&output[2], &ic_state.ic_vnr_pred_state.output_vnr_pred, sizeof(float_s32_t));
}
