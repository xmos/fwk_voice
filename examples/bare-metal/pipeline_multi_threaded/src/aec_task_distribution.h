...
/** Number of iterations run on a given thread when distributing 3 tasks,
...
/** Number of iterations run on a given thread when distributing 2 tasks,
 * max(AEC_MAX_Y_CHANNELS, AEC_MAX_X_CHANNELS) channels across AEC_THREAD_COUNT number of threads*/
#define AEC_2_TASKS_AND_CHANNELS_PASSES   (2)

/** Number of iterations run on a given thread when distributing 1 tasks,
 * max(AEC_MAX_Y_CHANNELS, AEC_MAX_X_CHANNELS) channels across AEC_THREAD_COUNT number of threads*/
...
typedef struct {
    /** task distribution definition for 3 tasks, max(AEC_MAX_Y_CHANNELS, AEC_MAX_X_CHANNELS) channels,
    ...
    /** task distribution definition for 2 tasks, max(AEC_MAX_Y_CHANNELS, AEC_MAX_X_CHANNELS) channels,
     * scheduled across AEC_THREAD_COUNT threads */
    par_tasks_and_channels_t par_2_tasks_and_channels[AEC_THREAD_COUNT][AEC_2_TASKS_AND_CHANNELS_PASSES];
    /** task distribution definition for 1 tasks, max(AEC_MAX_Y_CHANNELS, AEC_MAX_X_CHANNELS) channels,
     * scheduled across AEC_THREAD_COUNT threads */
